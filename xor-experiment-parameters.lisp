...
(defparameter *multiplier-for-random-weight* 4.9
...
(defparameter *disjoint-coefficient* 1.0
  "Used for compatibility computation.")
(defparameter *excess-coefficient* 1.0
  "Used for compatibility computation.")
(defparameter *weight-difference-coefficient* 3.0
  "Used for compatibility computation.")
(defparameter *compatibility-threshold* 5.5
...
(defparameter *age-significance* 0.5
...
(defparameter *harsh-max-weight-mutations* 30
  "Maximum times a genome can mutate when constructing initial population.")
(defparameter *death-rate-per-species* 0.15
...
(defparameter *split-connection-probability* 0.1
  "Probability that a connection will split when mutating genome.")
(defparameter *add-connection-probability* 0.3
